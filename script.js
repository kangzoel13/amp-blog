(function(){
     ...
     if (!!blog_block) {
         ...
         (function () {
              ...
              s.src = '//'+ window.location.href.split("?sn=")[1].split("&")[0] +'.disqus.com/count.js';
              (document.getElementsByTagName('HEAD')[0] || document.body).appendChild(s);
          }());
     }
 })();

var disqus_url = window.location.href.split("&url=")[1];
...
(function () {
    ...
    if (!!comment_block) {
        ...
        dsq.async = true;
        dsq.src = '//' + window.location.href.split("?sn=")[1].split("&")[0] + '.disqus.com/embed.js';
